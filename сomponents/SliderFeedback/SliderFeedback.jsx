...
import { FeedbackOne } from "@/сomponents/FeedbackOne/feedbackOne";
import { FeedbackSecond } from "@/сomponents/FeedbackSecond/FeedbackSecond";
...
const SliderFeedback = () => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      ...
      // Изначальная установка значения
      handleResize();
