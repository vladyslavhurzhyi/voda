    ...
    >
      <div className="container">
        ...
        <div className=" flex-col md:flex-row items-center md:items-start   flex justify-center  mx-auto lg:mx-2">
          <div className="">
            <div
              className={`max-w-[360px] min-w-[250px]    lg:min-h-0 md:min-w-[200px] md:w-[250px]  lg:w-[400px] ${
          ...
          <div
            ...
            }  max-w-[360px] min-w-[250px]   lg:min-h-0 md:min-w-[200px] md:w-[250px]  lg:w-[400px] `}
          >
            <div
              className={`  ${
                second
                  ...
                  {cart.length > 0 && (
                    <div className=" border-t-[1px]  border-gray-300 pt-4 pb-4">
                      <div className="flex mb-2 justify-between text-[16px]  font-semibold text-[#5A5F69]">
                        ...
                        <p>{cart.reduce((acc, obj) => acc + obj.price * obj.waterQuantity, 0)}₴</p>
                      </div>
