          ...
          <ul className="arguments">
            <li className="itemZdorova">
              ...
              <p className="textZdorova">
                Здорова вода допомагає організму видаляти шкідливі речовини та токсини, сприяючи
                здоров&apos;ю органів та систем.
              </p>
            </li>
            <li className="itemZdorova">
              <div className="imageZdorova">
              ...
              <p className="textZdorova">
                Ця вода сприяє покращенню обміну речовин, що може допомогти в підтримці оптимальної
                функції організму та енергії.
              </p>
            </li>
            <li className="itemZdorova">
              <div className="imageZdorova">
              ...
              <p className="textZdorova">
                Мінералізована вода містить поживні речовини, які можуть підтримати імунну систему,
                допомагаючи боротися зі захворюваннями.
              </p>
            </li>
            <li className="itemZdorova">
              <div className="imageZdorova">
              ...
              <p className="textZdorova">
                Очищена мінералізована вода може допомогти зменшити втому та стрес, оскільки вона
                надає важливі мінерали та забезпечує гарний гідратуючий ефект.
              </p>
            </li>
            <li className="itemZdorova">
              <div className="imageZdorova">
              ...
              <p className="textZdorova">
                Вона сприяє підтримці здорового кровообігу, що важливо для доставки поживних речовин
                по всьому організму.
              </p>
            </li>
            ...
            <li className="itemZdorova">
              ...
              <p className="titleZdorova colorMobile">Без консервантів та добавок</p>
              <p className="textZdorova">
                Ця вода є чистою та природною, вона не містить шкідливих додатків, консервантів або
          ...
          <div className="addInformation">
            <div className="infoItem">
              <Image
                ...
                alt="Вода в бутлях Котовского"
              />
              <p className="textDescriptionZdor forTabletMargin">Регулярний контроль якості</p>
            </div>
            <div className="infoItem">
              <Image
                className="ticImg"
