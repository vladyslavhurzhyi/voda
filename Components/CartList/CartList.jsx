                  ...
                  <div className=" flex gap-20 md:gap-0 justify-end  items-center mt-[20px] md:mt-0">
                    <div className=" mr-[auto] md:mr-[100px] ">
                      <div className="inline-flex gap-2 ">
                        ...
                        <p className=" text-[20px]  text-[#5A5F69]">{item.waterQuantity}</p>
                        <button
                          type="button"
                          onClick={() => {
                            increment(index);
                  ...
                  <div className="flex gap-20 md:gap-0 justify-end  items-center mt-[20px] md:mt-0">
                    <div className="mr-[auto] md:mr-[100px] ">
                      <div className="inline-flex gap-2 ">
                        ...
                        <p className=" text-[20px]  text-[#5A5F69]">{item.quantity}</p>
                        <button
                          type="button"
                          onClick={() => {
              ...
              <div className="flex  gap-20 md:gap-0 justify-end  items-center mt-[20px] md:mt-0  ">
                <div className="mr-[auto] md:mr-[100px] ">
                  <div className="inline-flex gap-2 ">
                    ...
                    <p className=" text-[20px]  text-[#5A5F69]">{taraQuantity}</p>
                    <button
                      type="button"
                      onClick={() => {
                        incrementTaraB();
