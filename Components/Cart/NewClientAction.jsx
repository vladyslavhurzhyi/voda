      ...
      <>
        <div className="pt-[24px]  max-w-[360px]  md:max-w-fit">
          <p className=" text-[#5A5F69] text-[14px]">
            Акції для нових клієнтів доступні для замовників, що замовляють воду вперше у нашій
            компаніі.
          </p>
        </div>
        ...
        <div className="pt-[24px] pb-8 relative ">
          <div
            ...
            className=" cursor-pointer  w-[100%] md:max-w-[859px] h-36 bg-sky-500 rounded-[14px] justify-start items-center gap-4 inline-flex"
          >
          ...
          <div
            ...
            className=" mt-4 cursor-pointer  w-[100%] md:max-w-[859px] h-36 bg-sky-500 rounded-[14px] justify-start items-center gap-4 inline-flex"
          >
            <div className="flex items-center justify-center text-white min-w-[150px] h-full bg-[#005087] rounded-l-[14px]">
              <p className=" text-[12px] px-2 md:px-0 md:text-[14px] ">
            ...
            <div className=" text-white mt-4 md:mt-0 md:ml-[40px] md:my-[28px] pr-2">
              ...
              <p className="text-[12px] md:text-[14px] lg:text-[16px]">
                Замовляйте три полікарбонатних бутля з водою + три тари і отримайте механічну помпу
                в подарунок.
              </p>
            </div>
            ...
            <div
              ...
              } rounded-[14px] absolute half-gray z-100 left-0 w-[100%] lg:max-w-[859px] h-36 `}
            ></div>
          </div>
        </div>
      </>
