  ...
  <SectionWrapper>
    <div className="wrapperInfo">
      ...
      <p className="textModal">
        Ваше оплата не пройшла. Спробуйте ще. Якщо у вас виникли додаткові питання, зателефонуйте
        ...
        <ul className="listIcons">
          <Link href="viber://chat?number=+380968836688">
            <li className="itemIcon">
              <Image src="/iconViberGrey.png" width={29.89} height={31.47} alt="Viber" />
            </li>
          </Link>
          <Link href="tg://resolve?domain=zdorova_voda_odesa">
            <li className="itemIcon">
              <Image src="/iconTelegramgrey.png" width={30.63} height={25.5} alt="Telegram" />
            </li>
          </Link>
          <Link href="https://www.facebook.com/profile.php?id=100094217051258">
            <li className="itemIcon">
              <Image src="/iconMessengerGrey.png" width={30} height={29.96} alt="Facebook" />
            </li>
          </Link>
          <Link href="https://www.instagram.com/zdorovavoda_odesa/">
            <li className="itemIcon">
              <Image src="/iconInstaGrey.png" width={28.5} height={28.5} alt="Instagram" />
            </li>
          </Link>
        </ul>
      </div>
