    ...
    <>
      ...
      <SectionWrapper>
        <ProductInfo imageSrc="/waterCooler.png" imageAlt={"Кулери для води Котовського"}>
          <ProductTypography
            variant="h1"
            text="Купити кулери для води: Котовського, Фонтанка, Крижанівка"
          />
          <ul className="listInfoCooler">
            <li>
              <ProductTypography
                text="На сайті &ldquo;Здорова Вода&rdquo; ви можете легко купити або орендувати кулери для
            ...
            <li>
              <ProductTypography
                text="Оренда кулера - це відмінний варіант для тих, хто не хоче витрачати великі кошти на
          ...
          <ProductTypography
            variant="h2"
            text="Як купити або орендувати кулери на сайті &ldquo;Здорова Вода&rdquo;"
          />
          <ul className="listInfoCooler">
            <li>
              <ProductTypography
                text="Ми пропонуємо настільні та підлогові варіанти, з верхнім чи нижнім підключенням, з
            ...
            <li>
              <ProductTypography
                text="Виберіть зручний для вас варіант на сайті &ldquo;Здорова Вода&rdquo; і замовте кулер з
